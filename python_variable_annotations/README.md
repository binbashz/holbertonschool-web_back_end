...
## Relevant PEPs[¶](https://docs.python.org/dev/library/typing.html#relevant-peps "Permalink to this heading")
...
The documentation for [`ParamSpec`](https://docs.python.org/dev/library/typing.html#typing.ParamSpec "typing.ParamSpec") and [`Concatenate`](https://docs.python.org/dev/library/typing.html#typing.Concatenate "typing.Concatenate") provides examples of usage in `Callable`.
...
## The type of class objects[¶](https://docs.python.org/dev/library/typing.html#the-type-of-class-objects "Permalink to this heading")
...
## User-defined generic types[¶](https://docs.python.org/dev/library/typing.html#user-defined-generic-types "Permalink to this heading")
...
A generic type can have any number of type variables. All varieties of [`TypeVar`](https://docs.python.org/dev/library/typing.html#typing.TypeVar "typing.TypeVar") are permissible as parameters for a generic type:
...
That means when the type of a value is [`object`](https://docs.python.org/dev/library/typing.htmlfunctions.html#object "object"), a type checker will reject almost all operations on it, and assigning it to a variable (or using it as a return value) of a more specialized type is a type error. For example:
...
typing.TypeGuard[¶](https://docs.python.org/dev/library/typing.html#typing.TypeGuard "Permalink to this definition")
...
_class_ typing.TypeVar(_name_, _\*constraints_, _bound\=None_, _covariant\=False_, _contravariant\=False_, _infer\_variance\=False_)[¶](https://docs.python.org/dev/library/typing.html#typing.TypeVar "Permalink to this definition")
...
Note that type variables can be _bound_, _constrained_, or neither, but cannot be both bound _and_ constrained.
...
At runtime, `isinstance(x, T)` will raise [`TypeError`](https://docs.python.org/dev/library/typing.htmlexceptions.html#TypeError "TypeError").
...
\_\_name\_\_[¶](https://docs.python.org/dev/library/typing.html#typing.TypeVarTuple.__name__ "Permalink to this definition")
...
Without `ParamSpec`, the simplest way to annotate this previously was to use a [`TypeVar`](https://docs.python.org/dev/library/typing.html#typing.TypeVar "typing.TypeVar") with bound `Callable[..., Any]`. However this causes two problems:
...
typing.ParamSpecKwargs[¶](https://docs.python.org/dev/library/typing.html#typing.ParamSpecKwargs "Permalink to this definition")
...
_class_ typing.NamedTuple[¶](https://docs.python.org/dev/library/typing.html#typing.NamedTuple "Permalink to this definition")
...
\_\_total\_\_[¶](https://docs.python.org/dev/library/typing.html#typing.TypedDict.__total__ "Permalink to this definition")
...
_class_ typing.SupportsRound[¶](https://docs.python.org/dev/library/typing.html#typing.SupportsRound "Permalink to this definition")
...
[Unreachable Code and Exhaustiveness Checking](https://typing.readthedocs.io/en/latest/source/unreachable.html) has more information about exhaustiveness checking with static typing.

New in version 3.11.

typing.reveal\_type(_obj_, _/_)[¶](https://docs.python.org/dev/library/typing.html#typing.reveal_type "Permalink to this definition")
...
@typing.dataclass\_transform(_\*_, _eq\_default\=True_, _order\_default\=False_, _kw\_only\_default\=False_, _frozen\_default\=False_, _field\_specifiers\=()_, _\*\*kwargs_)[¶](https://docs.python.org/dev/library/typing.html#typing.dataclass_transform "Permalink to this definition")

Decorator to mark an object as providing [`dataclass`](https://docs.python.org/dev/library/typing.htmldataclasses.html#dataclasses.dataclass "dataclasses.dataclass")\-like behavior.

`dataclass_transform` may be used to decorate a class, metaclass, or a function that is itself a decorator. The presence of `@dataclass_transform()` tells a static type checker that the decorated object performs runtime “magic” that transforms a class in a similar way to [`@dataclasses.dataclass`](https://docs.python.org/dev/library/typing.htmldataclasses.html#dataclasses.dataclass "dataclasses.dataclass").
...
-   **eq\_default** ([_bool_](https://docs.python.org/dev/library/typing.htmlfunctions.html#bool "bool")) – Indicates whether the `eq` parameter is assumed to be `True` or `False` if it is omitted by the caller. Defaults to `True`.
    
-   **order\_default** ([_bool_](https://docs.python.org/dev/library/typing.htmlfunctions.html#bool "bool")) – Indicates whether the `order` parameter is assumed to be `True` or `False` if it is omitted by the caller. Defaults to `False`.
    
-   **kw\_only\_default** ([_bool_](https://docs.python.org/dev/library/typing.htmlfunctions.html#bool "bool")) – Indicates whether the `kw_only` parameter is assumed to be `True` or `False` if it is omitted by the caller. Defaults to `False`.
    
-   **frozen\_default** ([_bool_](https://docs.python.org/dev/library/typing.htmlfunctions.html#bool "bool")) –
    
    Indicates whether the `frozen` parameter is assumed to be `True` or `False` if it is omitted by the caller. Defaults to `False`.
    
    New in version 3.12.
    
-   **field\_specifiers** ([_tuple_](https://docs.python.org/dev/library/typing.htmlstdtypes.html#tuple "tuple")_\[_[_Callable_](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Callable "collections.abc.Callable")_\[__...__,_ _Any__\]__,_ _...__\]_) – Specifies a static list of supported classes or functions that describe fields, similar to [`dataclasses.field()`](https://docs.python.org/dev/library/typing.htmldataclasses.html#dataclasses.field "dataclasses.field"). Defaults to `()`.
...
**Recognised parameters for field specifiers**[¶](https://docs.python.org/dev/library/typing.html#id7 "Permalink to this table")  
| 
Parameter name
...
Changed in version 3.11: Overloaded functions can now be introspected at runtime using [`get_overloads()`](https://docs.python.org/dev/library/typing.html#typing.get_overloads "typing.get_overloads").

typing.get\_overloads(_func_)[¶](https://docs.python.org/dev/library/typing.html#typing.get_overloads "Permalink to this definition")

Return a sequence of [`@overload`](https://docs.python.org/dev/library/typing.html#typing.overload "typing.overload")\-decorated definitions for _func_.
...
typing.clear\_overloads()[¶](https://docs.python.org/dev/library/typing.html#typing.clear_overloads "Permalink to this definition")
...
@typing.no\_type\_check[¶](https://docs.python.org/dev/library/typing.html#typing.no_type_check "Permalink to this definition")

Decorator to indicate that annotations are not type hints.

This works as a class or function [decorator](https://docs.python.org/dev/library/typing.html../glossary.html#term-decorator). With a class, it applies recursively to all methods and classes defined in that class (but not to methods defined in its superclasses or subclasses). Type checkers will ignore all annotations in a function or class with this decorator.

`@no_type_check` mutates the decorated object in place.

@typing.no\_type\_check\_decorator[¶](https://docs.python.org/dev/library/typing.html#typing.no_type_check_decorator "Permalink to this definition")

Decorator to give another decorator the [`no_type_check()`](https://docs.python.org/dev/library/typing.html#typing.no_type_check "typing.no_type_check") effect.

This wraps the decorator with something that wraps the decorated function in [`no_type_check()`](https://docs.python.org/dev/library/typing.html#typing.no_type_check "typing.no_type_check").
...
@typing.override[¶](https://docs.python.org/dev/library/typing.html#typing.override "Permalink to this definition")
...
@typing.type\_check\_only[¶](https://docs.python.org/dev/library/typing.html#typing.type_check_only "Permalink to this definition")
...
### Introspection helpers[¶](https://docs.python.org/dev/library/typing.html#introspection-helpers "Permalink to this heading")

typing.get\_type\_hints(_obj_, _globalns\=None_, _localns\=None_, _include\_extras\=False_)[¶](https://docs.python.org/dev/library/typing.html#typing.get_type_hints "Permalink to this definition")
...
The function recursively replaces all `Annotated[T, ...]` with `T`, unless `include_extras` is set to `True` (see [`Annotated`](https://docs.python.org/dev/library/typing.html#typing.Annotated "typing.Annotated") for more information). For example:
...
[`get_type_hints()`](https://docs.python.org/dev/library/typing.html#typing.get_type_hints "typing.get_type_hints") does not work with imported [type aliases](https://docs.python.org/dev/library/typing.html#type-aliases) that include forward references. Enabling postponed evaluation of annotations ([**PEP 563**](https://peps.python.org/pep-0563/)) may remove the need for most forward references.

Changed in version 3.9: Added `include_extras` parameter as part of [**PEP 593**](https://peps.python.org/pep-0593/). See the documentation on [`Annotated`](https://docs.python.org/dev/library/typing.html#typing.Annotated "typing.Annotated") for more information.
...
typing.get\_args(_tp_)[¶](https://docs.python.org/dev/library/typing.html#typing.get_args "Permalink to this definition")

Get type arguments with all substitutions performed: for a typing object of the form `X[Y, Z, ...]` return `(Y, Z, ...)`.

If `X` is a union or [`Literal`](https://docs.python.org/dev/library/typing.html#typing.Literal "typing.Literal") contained in another generic type, the order of `(Y, Z, ...)` may be different from the order of the original arguments `[Y, Z, ...]` due to type caching. Return `()` for unsupported objects.
...
typing.get\_protocol\_members(_tp_)[¶](https://docs.python.org/dev/library/typing.html#typing.get_protocol_members "Permalink to this definition")

Return the set of members defined in a [`Protocol`](https://docs.python.org/dev/library/typing.html#typing.Protocol "typing.Protocol").
...
Raise [`TypeError`](https://docs.python.org/dev/library/typing.htmlexceptions.html#TypeError "TypeError") for arguments that are not Protocols.

New in version 3.13.

typing.is\_protocol(_tp_)[¶](https://docs.python.org/dev/library/typing.html#typing.is_protocol "Permalink to this definition")

Determine if a type is a [`Protocol`](https://docs.python.org/dev/library/typing.html#typing.Protocol "typing.Protocol").
...
typing.is\_typeddict(_tp_)[¶](https://docs.python.org/dev/library/typing.html#typing.is_typeddict "Permalink to this definition")

Check if a type is a [`TypedDict`](https://docs.python.org/dev/library/typing.html#typing.TypedDict "typing.TypedDict").
...
_class_ typing.ForwardRef[¶](https://docs.python.org/dev/library/typing.html#typing.ForwardRef "Permalink to this definition")
...
### Constant[¶](https://docs.python.org/dev/library/typing.html#constant "Permalink to this heading")

typing.TYPE\_CHECKING[¶](https://docs.python.org/dev/library/typing.html#typing.TYPE_CHECKING "Permalink to this definition")
...
### Deprecated aliases[¶](https://docs.python.org/dev/library/typing.html#deprecated-aliases "Permalink to this heading")
...
#### Aliases to built-in types[¶](https://docs.python.org/dev/library/typing.html#aliases-to-built-in-types "Permalink to this heading")

_class_ typing.Dict(_dict, MutableMapping\[KT, VT\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Dict "Permalink to this definition")

Deprecated alias to [`dict`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#dict "dict").

Note that to annotate arguments, it is preferred to use an abstract collection type such as [`Mapping`](https://docs.python.org/dev/library/typing.html#typing.Mapping "typing.Mapping") rather than to use [`dict`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#dict "dict") or `typing.Dict`.
...
Deprecated since version 3.9: [`builtins.dict`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#dict "dict") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.List(_list, MutableSequence\[T\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.List "Permalink to this definition")

Deprecated alias to [`list`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#list "list").

Note that to annotate arguments, it is preferred to use an abstract collection type such as [`Sequence`](https://docs.python.org/dev/library/typing.html#typing.Sequence "typing.Sequence") or [`Iterable`](https://docs.python.org/dev/library/typing.html#typing.Iterable "typing.Iterable") rather than to use [`list`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#list "list") or `typing.List`.
...
Deprecated since version 3.9: [`builtins.list`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#list "list") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Set(_set, MutableSet\[T\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Set "Permalink to this definition")

Deprecated alias to [`builtins.set`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#set "set").

Note that to annotate arguments, it is preferred to use an abstract collection type such as [`AbstractSet`](https://docs.python.org/dev/library/typing.html#typing.AbstractSet "typing.AbstractSet") rather than to use [`set`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#set "set") or `typing.Set`.

Deprecated since version 3.9: [`builtins.set`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#set "set") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.FrozenSet(_frozenset, AbstractSet\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.FrozenSet "Permalink to this definition")

Deprecated alias to [`builtins.frozenset`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#frozenset "frozenset").

Deprecated since version 3.9: [`builtins.frozenset`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#frozenset "frozenset") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

typing.Tuple[¶](https://docs.python.org/dev/library/typing.html#typing.Tuple "Permalink to this definition")

Deprecated alias for [`tuple`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#tuple "tuple").

[`tuple`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#tuple "tuple") and `Tuple` are special-cased in the type system; see [Annotating tuples](https://docs.python.org/dev/library/typing.html#annotating-tuples) for more details.

Deprecated since version 3.9: [`builtins.tuple`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#tuple "tuple") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Type(_Generic\[CT\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Type "Permalink to this definition")

Deprecated alias to [`type`](https://docs.python.org/dev/library/typing.htmlfunctions.html#type "type").

See [The type of class objects](https://docs.python.org/dev/library/typing.html#type-of-class-objects) for details on using [`type`](https://docs.python.org/dev/library/typing.htmlfunctions.html#type "type") or `typing.Type` in type annotations.

New in version 3.5.2.

Deprecated since version 3.9: [`builtins.type`](https://docs.python.org/dev/library/typing.htmlfunctions.html#type "type") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

#### Aliases to types in [`collections`](https://docs.python.org/dev/library/typing.htmlcollections.html#module-collections "collections: Container datatypes")[¶](https://docs.python.org/dev/library/typing.html#aliases-to-types-in-collections "Permalink to this heading")

_class_ typing.DefaultDict(_collections.defaultdict, MutableMapping\[KT, VT\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.DefaultDict "Permalink to this definition")

Deprecated alias to [`collections.defaultdict`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.defaultdict "collections.defaultdict").

New in version 3.5.2.

Deprecated since version 3.9: [`collections.defaultdict`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.defaultdict "collections.defaultdict") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.OrderedDict(_collections.OrderedDict, MutableMapping\[KT, VT\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.OrderedDict "Permalink to this definition")

Deprecated alias to [`collections.OrderedDict`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.OrderedDict "collections.OrderedDict").

New in version 3.7.2.

Deprecated since version 3.9: [`collections.OrderedDict`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.OrderedDict "collections.OrderedDict") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.ChainMap(_collections.ChainMap, MutableMapping\[KT, VT\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.ChainMap "Permalink to this definition")

Deprecated alias to [`collections.ChainMap`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.ChainMap "collections.ChainMap").

New in version 3.5.4.

New in version 3.6.1.

Deprecated since version 3.9: [`collections.ChainMap`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.ChainMap "collections.ChainMap") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Counter(_collections.Counter, Dict\[T, int\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Counter "Permalink to this definition")

Deprecated alias to [`collections.Counter`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.Counter "collections.Counter").

New in version 3.5.4.

New in version 3.6.1.

Deprecated since version 3.9: [`collections.Counter`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.Counter "collections.Counter") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Deque(_deque, MutableSequence\[T\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Deque "Permalink to this definition")

Deprecated alias to [`collections.deque`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.deque "collections.deque").

New in version 3.5.4.

New in version 3.6.1.

Deprecated since version 3.9: [`collections.deque`](https://docs.python.org/dev/library/typing.htmlcollections.html#collections.deque "collections.deque") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

#### Aliases to other concrete types[¶](https://docs.python.org/dev/library/typing.html#aliases-to-other-concrete-types "Permalink to this heading")

_class_ typing.Pattern[¶](https://docs.python.org/dev/library/typing.html#typing.Pattern "Permalink to this definition")

_class_ typing.Match[¶](https://docs.python.org/dev/library/typing.html#typing.Match "Permalink to this definition")

Deprecated aliases corresponding to the return types from [`re.compile()`](https://docs.python.org/dev/library/typing.htmlre.html#re.compile "re.compile") and [`re.match()`](https://docs.python.org/dev/library/typing.htmlre.html#re.match "re.match").

These types (and the corresponding functions) are generic over [`AnyStr`](https://docs.python.org/dev/library/typing.html#typing.AnyStr "typing.AnyStr"). `Pattern` can be specialised as `Pattern[str]` or `Pattern[bytes]`; `Match` can be specialised as `Match[str]` or `Match[bytes]`.

Deprecated since version 3.9: Classes `Pattern` and `Match` from [`re`](https://docs.python.org/dev/library/typing.htmlre.html#module-re "re: Regular expression operations.") now support `[]`. See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Text[¶](https://docs.python.org/dev/library/typing.html#typing.Text "Permalink to this definition")

Deprecated alias for [`str`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#str "str").
...
Deprecated since version 3.11: Python 2 is no longer supported, and most type checkers also no longer support type checking Python 2 code. Removal of the alias is not currently planned, but users are encouraged to use [`str`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#str "str") instead of `Text`.

#### Aliases to container ABCs in [`collections.abc`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#module-collections.abc "collections.abc: Abstract base classes for containers")[¶](https://docs.python.org/dev/library/typing.html#aliases-to-container-abcs-in-collections-abc "Permalink to this heading")

_class_ typing.AbstractSet(_Collection\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.AbstractSet "Permalink to this definition")

Deprecated alias to [`collections.abc.Set`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Set "collections.abc.Set").

Deprecated since version 3.9: [`collections.abc.Set`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Set "collections.abc.Set") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.ByteString(_Sequence\[int\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.ByteString "Permalink to this definition")

This type represents the types [`bytes`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#bytes "bytes"), [`bytearray`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#bytearray "bytearray"), and [`memoryview`](https://docs.python.org/dev/library/typing.htmlstdtypes.html#memoryview "memoryview") of byte sequences.

Deprecated since version 3.9, will be removed in version 3.14: Prefer [`collections.abc.Buffer`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Buffer "collections.abc.Buffer"), or a union like `bytes | bytearray | memoryview`.

_class_ typing.Collection(_Sized, Iterable\[T\_co\], Container\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Collection "Permalink to this definition")

Deprecated alias to [`collections.abc.Collection`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Collection "collections.abc.Collection").

New in version 3.6.0.

Deprecated since version 3.9: [`collections.abc.Collection`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Collection "collections.abc.Collection") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Container(_Generic\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Container "Permalink to this definition")

Deprecated alias to [`collections.abc.Container`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Container "collections.abc.Container").

Deprecated since version 3.9: [`collections.abc.Container`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Container "collections.abc.Container") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.ItemsView(_MappingView, AbstractSet\[tuple\[KT\_co, VT\_co\]\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.ItemsView "Permalink to this definition")

Deprecated alias to [`collections.abc.ItemsView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.ItemsView "collections.abc.ItemsView").

Deprecated since version 3.9: [`collections.abc.ItemsView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.ItemsView "collections.abc.ItemsView") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.KeysView(_MappingView, AbstractSet\[KT\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.KeysView "Permalink to this definition")

Deprecated alias to [`collections.abc.KeysView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.KeysView "collections.abc.KeysView").

Deprecated since version 3.9: [`collections.abc.KeysView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.KeysView "collections.abc.KeysView") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Mapping(_Collection\[KT\], Generic\[KT, VT\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Mapping "Permalink to this definition")

Deprecated alias to [`collections.abc.Mapping`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Mapping "collections.abc.Mapping").
...
Deprecated since version 3.9: [`collections.abc.Mapping`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Mapping "collections.abc.Mapping") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.MappingView(_Sized_)[¶](https://docs.python.org/dev/library/typing.html#typing.MappingView "Permalink to this definition")

Deprecated alias to [`collections.abc.MappingView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MappingView "collections.abc.MappingView").

Deprecated since version 3.9: [`collections.abc.MappingView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MappingView "collections.abc.MappingView") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.MutableMapping(_Mapping\[KT, VT\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.MutableMapping "Permalink to this definition")

Deprecated alias to [`collections.abc.MutableMapping`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MutableMapping "collections.abc.MutableMapping").

Deprecated since version 3.9: [`collections.abc.MutableMapping`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MutableMapping "collections.abc.MutableMapping") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.MutableSequence(_Sequence\[T\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.MutableSequence "Permalink to this definition")

Deprecated alias to [`collections.abc.MutableSequence`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MutableSequence "collections.abc.MutableSequence").

Deprecated since version 3.9: [`collections.abc.MutableSequence`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MutableSequence "collections.abc.MutableSequence") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.MutableSet(_AbstractSet\[T\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.MutableSet "Permalink to this definition")

Deprecated alias to [`collections.abc.MutableSet`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MutableSet "collections.abc.MutableSet").

Deprecated since version 3.9: [`collections.abc.MutableSet`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.MutableSet "collections.abc.MutableSet") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Sequence(_Reversible\[T\_co\], Collection\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Sequence "Permalink to this definition")

Deprecated alias to [`collections.abc.Sequence`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Sequence "collections.abc.Sequence").

Deprecated since version 3.9: [`collections.abc.Sequence`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Sequence "collections.abc.Sequence") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.ValuesView(_MappingView, Collection\[\_VT\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.ValuesView "Permalink to this definition")

Deprecated alias to [`collections.abc.ValuesView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.ValuesView "collections.abc.ValuesView").

Deprecated since version 3.9: [`collections.abc.ValuesView`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.ValuesView "collections.abc.ValuesView") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

#### Aliases to asynchronous ABCs in [`collections.abc`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#module-collections.abc "collections.abc: Abstract base classes for containers")[¶](https://docs.python.org/dev/library/typing.html#aliases-to-asynchronous-abcs-in-collections-abc "Permalink to this heading")

_class_ typing.Coroutine(_Awaitable\[ReturnType\], Generic\[YieldType, SendType, ReturnType\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Coroutine "Permalink to this definition")

Deprecated alias to [`collections.abc.Coroutine`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Coroutine "collections.abc.Coroutine").

The variance and order of type variables correspond to those of [`Generator`](https://docs.python.org/dev/library/typing.html#typing.Generator "typing.Generator"), for example:
...
Deprecated since version 3.9: [`collections.abc.Coroutine`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Coroutine "collections.abc.Coroutine") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.AsyncGenerator(_AsyncIterator\[YieldType\], Generic\[YieldType, SendType\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.AsyncGenerator "Permalink to this definition")

Deprecated alias to [`collections.abc.AsyncGenerator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.AsyncGenerator "collections.abc.AsyncGenerator").
...
Unlike normal generators, async generators cannot return a value, so there is no `ReturnType` type parameter. As with [`Generator`](https://docs.python.org/dev/library/typing.html#typing.Generator "typing.Generator"), the `SendType` behaves contravariantly.
...
Deprecated since version 3.9: [`collections.abc.AsyncGenerator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.AsyncGenerator "collections.abc.AsyncGenerator") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.AsyncIterable(_Generic\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.AsyncIterable "Permalink to this definition")

Deprecated alias to [`collections.abc.AsyncIterable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.AsyncIterable "collections.abc.AsyncIterable").

New in version 3.5.2.

Deprecated since version 3.9: [`collections.abc.AsyncIterable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.AsyncIterable "collections.abc.AsyncIterable") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.AsyncIterator(_AsyncIterable\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.AsyncIterator "Permalink to this definition")

Deprecated alias to [`collections.abc.AsyncIterator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.AsyncIterator "collections.abc.AsyncIterator").

New in version 3.5.2.

Deprecated since version 3.9: [`collections.abc.AsyncIterator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.AsyncIterator "collections.abc.AsyncIterator") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Awaitable(_Generic\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Awaitable "Permalink to this definition")

Deprecated alias to [`collections.abc.Awaitable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Awaitable "collections.abc.Awaitable").

New in version 3.5.2.

Deprecated since version 3.9: [`collections.abc.Awaitable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Awaitable "collections.abc.Awaitable") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

#### Aliases to other ABCs in [`collections.abc`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#module-collections.abc "collections.abc: Abstract base classes for containers")[¶](https://docs.python.org/dev/library/typing.html#aliases-to-other-abcs-in-collections-abc "Permalink to this heading")

_class_ typing.Iterable(_Generic\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Iterable "Permalink to this definition")

Deprecated alias to [`collections.abc.Iterable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Iterable "collections.abc.Iterable").

Deprecated since version 3.9: [`collections.abc.Iterable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Iterable "collections.abc.Iterable") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Iterator(_Iterable\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Iterator "Permalink to this definition")

Deprecated alias to [`collections.abc.Iterator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Iterator "collections.abc.Iterator").

Deprecated since version 3.9: [`collections.abc.Iterator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Iterator "collections.abc.Iterator") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

typing.Callable[¶](https://docs.python.org/dev/library/typing.html#typing.Callable "Permalink to this definition")

Deprecated alias to [`collections.abc.Callable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Callable "collections.abc.Callable").
...
_class_ typing.Generator(_Iterator\[YieldType\], Generic\[YieldType, SendType, ReturnType\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Generator "Permalink to this definition")

Deprecated alias to [`collections.abc.Generator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Generator "collections.abc.Generator").
...
Note that unlike many other generics in the typing module, the `SendType` of [`Generator`](https://docs.python.org/dev/library/typing.html#typing.Generator "typing.Generator") behaves contravariantly, not covariantly or invariantly.
...
Deprecated since version 3.9: [`collections.abc.Generator`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Generator "collections.abc.Generator") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Hashable[¶](https://docs.python.org/dev/library/typing.html#typing.Hashable "Permalink to this definition")

Deprecated alias to [`collections.abc.Hashable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Hashable "collections.abc.Hashable").

Deprecated since version 3.12: Use [`collections.abc.Hashable`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Hashable "collections.abc.Hashable") directly instead.

_class_ typing.Reversible(_Iterable\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.Reversible "Permalink to this definition")

Deprecated alias to [`collections.abc.Reversible`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Reversible "collections.abc.Reversible").

Deprecated since version 3.9: [`collections.abc.Reversible`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Reversible "collections.abc.Reversible") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.Sized[¶](https://docs.python.org/dev/library/typing.html#typing.Sized "Permalink to this definition")

Deprecated alias to [`collections.abc.Sized`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Sized "collections.abc.Sized").

Deprecated since version 3.12: Use [`collections.abc.Sized`](https://docs.python.org/dev/library/typing.htmlcollections.abc.html#collections.abc.Sized "collections.abc.Sized") directly instead.

#### Aliases to [`contextlib`](https://docs.python.org/dev/library/typing.htmlcontextlib.html#module-contextlib "contextlib: Utilities for with-statement contexts.") ABCs[¶](https://docs.python.org/dev/library/typing.html#aliases-to-contextlib-abcs "Permalink to this heading")

_class_ typing.ContextManager(_Generic\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.ContextManager "Permalink to this definition")

Deprecated alias to [`contextlib.AbstractContextManager`](https://docs.python.org/dev/library/typing.htmlcontextlib.html#contextlib.AbstractContextManager "contextlib.AbstractContextManager").

New in version 3.5.4.

New in version 3.6.0.

Deprecated since version 3.9: [`contextlib.AbstractContextManager`](https://docs.python.org/dev/library/typing.htmlcontextlib.html#contextlib.AbstractContextManager "contextlib.AbstractContextManager") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).

_class_ typing.AsyncContextManager(_Generic\[T\_co\]_)[¶](https://docs.python.org/dev/library/typing.html#typing.AsyncContextManager "Permalink to this definition")

Deprecated alias to [`contextlib.AbstractAsyncContextManager`](https://docs.python.org/dev/library/typing.htmlcontextlib.html#contextlib.AbstractAsyncContextManager "contextlib.AbstractAsyncContextManager").

New in version 3.5.4.

New in version 3.6.2.

Deprecated since version 3.9: [`contextlib.AbstractAsyncContextManager`](https://docs.python.org/dev/library/typing.htmlcontextlib.html#contextlib.AbstractAsyncContextManager "contextlib.AbstractAsyncContextManager") now supports subscripting (`[]`). See [**PEP 585**](https://peps.python.org/pep-0585/) and [Generic Alias Type](https://docs.python.org/dev/library/typing.htmlstdtypes.html#types-genericalias).
